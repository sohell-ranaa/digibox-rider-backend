...
@section('title', 'Add Installation Location')
...
<li class="breadcrumb-item active" aria-current="page"><i class="bi bi-plus-circle"></i> Create</li>
@endsection
...
<div class="container-fluid">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h4 class="fw-bold mb-2">
                    <i class="bi bi-plus-circle"></i> Add New Installation Location
                </h4>
                <p class="mb-0 opacity-90">Create a new installation site with geofence zone</p>
            </div>
    ...
    <form action="{{ route('installations.store') }}" method="POST" id="createForm">
        @csrf
            ...
            <div class="col-12 col-lg-7">
                <div class="form-card">
                    <h5 class="fw-bold mb-4">
                        <i class="bi bi-info-circle-fill text-success"></i> Location Information
                    </h5>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea
                            ...
                            rows="3"
                            placeholder="Enter full address with street, city, and postcode">{{ old('address') }}</textarea>
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="info-box">
                        <div class="d-flex align-items-start gap-2">
                            ...
                            <div>
                                <strong>Tip:</strong> Click on the map to set coordinates, drag the marker to adjust, or enter coordinates manually.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="range-slider-container">
                            <span class="range-value" id="radiusValue">{{ old('geofence_radius_meters', 100) }}m</span>
                            <input
                                type="range"
                                class="form-range"
                                id="radiusSlider"
                                ...
                                max="500"
                                step="10"
                                value="{{ old('geofence_radius_meters', 100) }}">
                            <input
                                type="hidden"
                    ...
                    <div class="d-flex gap-3 mt-5">
                        <button type="submit" class="btn btn-success btn-action flex-fill">
                ...
                <div class="map-card">
                    ...
                    <div class="map-info">
                        ...
                        <div class="info-item">
                            ...
                            <div class="flex-fill">
                                <small class="text-muted">Marker Position</small>
                                <div class="fw-semibold" id="currentCoords">
                                    {{ old('latitude', '3.0339') }}, {{ old('longitude', '101.7598') }}
                                </div>
                            </div>
                        </div>
                        <div class="info-item">
                            ...
                            <div class="flex-fill">
                                ...
                                <div class="fw-semibold" id="currentRadius">{{ old('geofence_radius_meters', 100) }}m</div>
                            </div>
                        </div>
                        <div class="info-item">
                            <i class="bi bi-hand-index text-success"></i>
                            <div class="flex-fill">
                                <small class="text-muted">Click map or drag marker to set location</small>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    // Initialize map (centered on Balakong/Cheras area)
    const defaultLat = {{ old('latitude', '3.0339') }};
    const defaultLng = {{ old('longitude', '101.7598') }};
    const defaultRadius = {{ old('geofence_radius_meters', 100) }};
